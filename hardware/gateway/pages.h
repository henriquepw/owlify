...
String rootPage(long id, String networkWifi, float temperature, float humidity) {
  ...
  page += temperature;
  page += "</p></li><li><strong>Humidity: </strong><p>"; 
  page += humidity;
